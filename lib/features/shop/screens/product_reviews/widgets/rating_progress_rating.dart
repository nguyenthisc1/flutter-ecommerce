import 'package:ecommerce/features/shop/screens/product_reviews/widgets/progress_indacator_rating.dart';
        ...
        const Expanded(
          ...
          child: Column(
            children: [
              ...
              TRatingProgressIndicator(text: '4', value: 0.6),
              TRatingProgressIndicator(text: '3', value: 0.8),
